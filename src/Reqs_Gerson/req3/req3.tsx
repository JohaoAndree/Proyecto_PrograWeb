    ...
    return (
        <div className={styles.fondoAzulOsc}>
            <div className={styles.cajaRegist}>
                ...
                <button id="buttonRegis" className="btn w-100 mb-2 btn-light" onClick={onClick}>Registrar</button>

                <div id="mensajes" className="text-center mt-2 text-light">
                    {mensaje}
                    {correoEnviado && <div>Registro exitoso. Revisa tu correo electrónico para activar tu cuenta.</div>}
                </div>
            </div>
        </div>
    );
